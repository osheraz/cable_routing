    ...
    for k in range(len(goal_keypoints) - 1):
        ...
        for l in range(num_steps):
            goal_sequence.append(
                (
                    goal_keypoints[k][0]
                    + (goal_keypoints[k + 1][0] - goal_keypoints[k][0]) // num_steps,
                    goal_keypoints[k][1]
                    + (goal_keypoints[k + 1][1] - goal_keypoints[k][1]) // num_steps,
                )
            )
    ...
    for k in range(len(cur_keypoints) - 1):
        ...
        for l in range(num_steps):
            cur_sequence.append(
                (
                    cur_keypoints[k][0]
                    + (cur_keypoints[k + 1][0] - cur_keypoints[k][0]) // num_steps,
                    cur_keypoints[k][1]
                    + (cur_keypoints[k + 1][1] - cur_keypoints[k][1]) // num_steps,
                )
            )
