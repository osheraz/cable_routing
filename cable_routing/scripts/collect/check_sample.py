...
from cable_routing.env.ext_camera.utils.pcl_utils import depth_to_pointcloud, visualize_pointcloud
    ...
    try:
        with h5py.File(hdf5_file_path, 'r') as hdf:
            ...
            for i in range(2):
                ...
                points, colors = depth_to_pointcloud(depth_map, zed_frame, intrinsics, transform)
...
if __name__ == "__main__":
    ...
    play_videos_and_project_depth(hdf5_file_path,
                                  brio_dataset_path,
                                  zed_dataset_path,
                                  zed_depth_path,
                                  zed_intrinsics,
